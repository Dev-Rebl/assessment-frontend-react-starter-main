...
export const Login = () => {
  ...
  return (
    <div className="p-8 h-screen flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
      ...
      <form onSubmit={sendData} className="md:w-1/3 max-w-sm">
        <input
          className="w-full rounded border-2 text-white border-white-200 bg-transparent p-2 mb-4"
          name="email"
          type="email"
        ...
        />
        <input
          className="w-full rounded border-2 text-white border-white-200 bg-transparent p-2"
          name="password"
          type="password"
